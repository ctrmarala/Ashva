    ...
    def _load_baseline_alphas(self):
        ...
        records = [
            ...
            AlphaResearchRecord(
                ...
                mechanism_description="Opening 09:15 volume >= 1.2x 10-day max opening volume with moderate gap and directional candle body",
                timeframe="15m",
                entry_window="09:30",
                holding_concept="Intraday 15:15 Square-off, RR 1.5",
                status=MechanismStatus.PROVEN,
                pnl_540d_inr=25516,
                sharpe_540d=3.05,
                oos_trades=22,
                oos_pnl_inr=14824,
                positive_assets=["INFY", "TCS", "ICICIBANK", "HDFCBANK", "SBIN", "RELIANCE", "LT", "BHARTIARTL", "BAJFINANCE", "MARUTI"],
            ),
            AlphaResearchRecord(
                alpha_id="alpha_72",
                name="ALPHA_72_NR3_VOLATILITY_EXPANSION",
                category=AlphaCategory.VOLATILITY_EXPANSION,
                mechanism_description="3-day range compression (NR3) opening directional breakout with RVOL >= 1.5x",
                timeframe="15m",
                entry_window="09:30",
                holding_concept="Intraday 15:15 Square-off, RR 2.0",
                status=MechanismStatus.PROVEN,
                pnl_540d_inr=15523,
                sharpe_540d=2.01,
                oos_trades=11,
                oos_pnl_inr=12611,
                positive_assets=["INFY", "TCS", "HDFCBANK", "SBIN", "RELIANCE", "BAJFINANCE", "MARUTI"],
            ),
            AlphaResearchRecord(
                alpha_id="alpha_73",
                name="ALPHA_73_INSIDE_DAY_EXPANSION",
                category=AlphaCategory.VOLATILITY_EXPANSION,
                mechanism_description="Inside day compression opening directional expansion with RVOL >= 1.2x",
                timeframe="15m",
                entry_window="09:30",
                holding_concept="Intraday 15:15 Square-off, RR 1.5",
                status=MechanismStatus.PROVEN,
                ...
                oos_trades=1,
                oos_pnl_inr=924,
                positive_assets=["INFY", "ICICIBANK", "HDFCBANK", "SBIN", "RELIANCE", "BAJFINANCE", "SUNPHARMA"],
            ),
            AlphaResearchRecord(
                alpha_id="alpha_74",
                name="ALPHA_74_GAP_MARUBOZU_MOMENTUM",
                category=AlphaCategory.GAP_MOMENTUM,
                mechanism_description="Opening Marubozu (Body >= 70%) with gap 0.25%-1.20% and RVOL >= 1.25x",
                timeframe="15m",
                entry_window="09:30",
                holding_concept="Intraday 15:15 Square-off, RR 1.5",
                status=MechanismStatus.PROVEN,
                ...
                oos_trades=45,
                oos_pnl_inr=11717,
                positive_assets=["INFY", "TCS", "ICICIBANK", "HDFCBANK", "SBIN", "RELIANCE", "LT", "BAJFINANCE", "MARUTI"],
            ),
            AlphaResearchRecord(
                alpha_id="alpha_37",
                name="ALPHA_37_GAP_VOLUME_SHOCK_DRIFT",
                category=AlphaCategory.GAP_MOMENTUM,
                mechanism_description="Gap + 09:15 Volume Shock >= 2.0x 20-day time-of-day mean",
                timeframe="15m",
                entry_window="09:30",
                holding_concept="Intraday 15:15 Square-off, RR 1.5",
                status=MechanismStatus.PROVEN,
            ...
            AlphaResearchRecord(
                ...
                category=AlphaCategory.ORDER_FLOW_IMBALANCE,
                mechanism_description="Opening bar records highest volume of last 10 days with moderate gap",
                timeframe="15m",
                entry_window="09:30",
                holding_concept="Intraday 15:15 Square-off, RR 1.5",
                status=MechanismStatus.PROVEN,
            ...
            AlphaResearchRecord(
                alpha_id="alpha_46",
                name="ALPHA_46_HIGH_CONVICTION_GAP_DRIFT",
                category=AlphaCategory.GAP_MOMENTUM,
                mechanism_description="High-conviction opening gap with RVOL >= 1.75x and tight stop",
                timeframe="15m",
                entry_window="09:30",
                holding_concept="Intraday 15:15 Square-off, RR 1.5",
                status=MechanismStatus.PROVEN,
                ...
                oos_trades=22,
                oos_pnl_inr=1246,
                positive_assets=["INFY", "TCS", "ICICIBANK", "HDFCBANK", "SBIN", "RELIANCE", "LT", "MARUTI"],
            ),
        ]
        for r in records:
