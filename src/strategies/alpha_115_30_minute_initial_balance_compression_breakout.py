"""
Ashva Quantitative Strategy: 30-Minute Initial Balance Compression Breakout (115_alpha)
Category: INITIAL_BALANCE_EXPANSION
Market Mechanism: BREAKOUT

Hypothesis:
30-minute Initial Balance range compression followed by high-volume breakout.
"""
...
class Alpha115ThirtyMinuteInitialBalanceCompressionBreakout(BaseHypothesis, BaseStrategy):
    strategy_id = "115_alpha"
    hypothesis_id = "115_alpha"
    name = "115_alpha — 30-Minute Initial Balance Compression Breakout"
    ...
    def __init__(self, parameters: Optional[Dict[str, Any]] = None):
        ...
        metadata = HypothesisMetadata(
            ...
            name="115_alpha — 30-Minute Initial Balance Compression Breakout",
            category="INITIAL_BALANCE_EXPANSION",
            economic_rationale="30-minute Initial Balance range compression followed by high-volume breakout.",
            target_instruments=[],
            timeframe="15m",
        ...
        BaseStrategy.__init__(self, strategy_id="115_alpha", parameters=merged)
