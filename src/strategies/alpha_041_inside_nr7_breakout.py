"""
Ashva Quantitative Strategy: Inside Day NR7 Dual Coiled Cannon (Alpha 41)
Category: VOLATILITY_CONTRACTION_EXPANSION
Market Mechanism: BREAKOUT

Hypothesis:
When Day T-1 is simultaneously an Inside Day AND an NR7 (Narrowest Range of 7 Days), market volatility
reaches its lowest weekly boundary. An opening gap on Day T accompanied by Relative Volume (RVOL >= 1.25x)
unleashes immense directional expansion with minimal false breakouts.
"""
...
class Alpha41InsideNR7Breakout(BaseHypothesis, BaseStrategy):
    strategy_id = "41_alpha"
    hypothesis_id = "41_alpha"
    name = "41_alpha — Inside Day NR7 Dual Coiled Cannon"
    ...
    def __init__(self, parameters: Optional[Dict[str, Any]] = None):
        ...
        metadata = HypothesisMetadata(
            ...
            category="VOLATILITY_CONTRACTION_EXPANSION",
            economic_rationale=(
                "Combining Inside Day with 7-day narrowest range (NR7) captures extreme multi-session volatility "
        ...
        BaseStrategy.__init__(self, strategy_id="41_alpha", parameters=merged)
    ...
    def generate_signals(self, df: pd.DataFrame) -> pd.DataFrame:
        ...
        is_nr7 = rng.shift(1) < rng.shift(2).rolling(6, min_periods=6).min()
