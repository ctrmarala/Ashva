"""
Ashva Quantitative Strategy: Inside Day VWAP Equilibrium Spring (105_alpha)
Category: VWAP_MEAN_REVERSION
Market Mechanism: MEAN_REVERSION

Hypothesis:
Inside day compression + VWAP test and reclaim under daily 50 SMA trend alignment.
"""
...
class Alpha105InsideDayVwapEquilibriumSpring(BaseHypothesis, BaseStrategy):
    strategy_id = "105_alpha"
    hypothesis_id = "105_alpha"
    name = "105_alpha — Inside Day VWAP Equilibrium Spring"
    ...
    def __init__(self, parameters: Optional[Dict[str, Any]] = None):
        ...
        metadata = HypothesisMetadata(
            ...
            name="105_alpha — Inside Day VWAP Equilibrium Spring",
            category="VWAP_MEAN_REVERSION",
            economic_rationale="Inside day compression + VWAP test and reclaim under daily 50 SMA trend alignment.",
            target_instruments=[],
            timeframe="15m",
