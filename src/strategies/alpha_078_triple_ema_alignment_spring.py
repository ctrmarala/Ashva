"""
Ashva Quantitative Strategy: Triple EMA (10/20/50) Trend Alignment Compression Spring (Alpha 78)
Category: TRIPLE_EMA_TREND_SPRING
Market Mechanism: MOMENTUM_EXPANSION

Hypothesis:
When a liquid equity exhibits a textbook triple exponential moving average alignment stack
(Close[T-1] > 10 EMA > 20 EMA > 50 EMA for Long, or Close[T-1] < 10 EMA < 20 EMA < 50 EMA for Short)
and tight daily volatility compression (Range[T-1] <= 0.75x 14-day ATR), institutional order flow is primed for expansion.
...
class Alpha78TripleEMAAlignmentSpring(BaseHypothesis, BaseStrategy):
    strategy_id = "78_alpha"
    hypothesis_id = "78_alpha"
    name = "78_alpha — Triple EMA (10/20/50) Trend Compression Spring"
    ...
    def __init__(self, parameters: Optional[Dict[str, Any]] = None):
        ...
        metadata = HypothesisMetadata(
            ...
            category="TRIPLE_EMA_TREND_SPRING",
            economic_rationale=(
                "Triple EMA (10/20/50) directional alignment combined with sub-0.75x ATR daily volatility compression "
        ...
        BaseStrategy.__init__(self, strategy_id="78_alpha", parameters=merged)
    ...
    def generate_signals(self, df: pd.DataFrame) -> pd.DataFrame:
        ...
        ema10 = c.shift(1).ewm(span=10, adjust=False).mean()
        ...
        is_bull_trend = (c1 > ema10) & (ema10 > ema20) & (ema20 > ema50) & is_orderly
        is_bear_trend = (c1 < ema10) & (ema10 < ema20) & (ema20 < ema50) & is_orderly
