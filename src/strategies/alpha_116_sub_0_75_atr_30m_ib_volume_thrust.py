"""
Ashva Quantitative Strategy: Sub-0.75 ATR 30m IB Volume Thrust (116_alpha)
Category: INITIAL_BALANCE_EXPANSION
Market Mechanism: BREAKOUT

Hypothesis:
Sub-0.75 ATR multi-day compression exploding past 30m initial balance.
"""
...
class Alpha116Sub075Atr30mIbVolumeThrust(BaseHypothesis, BaseStrategy):
    strategy_id = "116_alpha"
    hypothesis_id = "116_alpha"
    name = "116_alpha — Sub-0.75 ATR 30m IB Volume Thrust"
    ...
    def __init__(self, parameters: Optional[Dict[str, Any]] = None):
        ...
        metadata = HypothesisMetadata(
            ...
            name="116_alpha — Sub-0.75 ATR 30m IB Volume Thrust",
            category="INITIAL_BALANCE_EXPANSION",
            economic_rationale="Sub-0.75 ATR multi-day compression exploding past 30m initial balance.",
            target_instruments=[],
            timeframe="15m",
        ...
        BaseStrategy.__init__(self, strategy_id="116_alpha", parameters=merged)
