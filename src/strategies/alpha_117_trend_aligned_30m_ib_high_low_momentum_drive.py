"""
Ashva Quantitative Strategy: Trend-Aligned 30m IB High-Low Momentum Drive (117_alpha)
Category: INITIAL_BALANCE_EXPANSION
Market Mechanism: BREAKOUT

Hypothesis:
2-day directional momentum driving through opening 30-min range boundaries.
"""
...
class Alpha117TrendAligned30mIbHighLowMomentumDrive(BaseHypothesis, BaseStrategy):
    strategy_id = "117_alpha"
    hypothesis_id = "117_alpha"
    name = "117_alpha — Trend-Aligned 30m IB High-Low Momentum Drive"
    ...
    def __init__(self, parameters: Optional[Dict[str, Any]] = None):
        ...
        metadata = HypothesisMetadata(
            ...
            name="117_alpha — Trend-Aligned 30m IB High-Low Momentum Drive",
            category="INITIAL_BALANCE_EXPANSION",
            economic_rationale="2-day directional momentum driving through opening 30-min range boundaries.",
            target_instruments=[],
            timeframe="15m",
        ...
        BaseStrategy.__init__(self, strategy_id="117_alpha", parameters=merged)
        self._current_pos: Dict[str, float] = {}

    def get_parameter_grid(self) -> Dict[str, List[Any]]:
        return {
            "min_gap": [0.0035, 0.0035 + 0.0010],
            "target_rr": [1.9, 1.9 + 0.15],
        }
    ...
    def generate_signals(self, df: pd.DataFrame) -> pd.DataFrame:
        ...
        is_orderly = rng.shift(1) <= (0.75 * atr14)
        is_bull_setup = (c1 > c2) & (c2 > h3) & (c1 > sma50) & is_orderly
        is_bear_setup = (c1 < c2) & (c2 < l3) & (c1 < sma50) & is_orderly
        ...
        target_rr = float(self.parameters.get("target_rr", 1.9))
