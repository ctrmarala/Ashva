"""
Ashva Quantitative Strategy: Inside Day Volume Contraction VWAP Spring (107_alpha)
Category: VWAP_MEAN_REVERSION
Market Mechanism: MEAN_REVERSION

Hypothesis:
Inside day and volume contraction coiled spring with volume-weighted equilibrium expansion.
"""
...
class Alpha107DualInsideDayVwapBandEquilibriumSpring(BaseHypothesis, BaseStrategy):
    strategy_id = "107_alpha"
    hypothesis_id = "107_alpha"
    name = "107_alpha — Inside Day Volume Contraction VWAP Spring"
    ...
    def __init__(self, parameters: Optional[Dict[str, Any]] = None):
        ...
        metadata = HypothesisMetadata(
            ...
            name="107_alpha — Inside Day Volume Contraction VWAP Spring",
            category="VWAP_MEAN_REVERSION",
            economic_rationale="Inside day and volume contraction coiled spring with volume-weighted equilibrium expansion.",
            target_instruments=[],
            timeframe="15m",
        ...
        BaseStrategy.__init__(self, strategy_id="107_alpha", parameters=merged)
    ...
    def generate_signals(self, df: pd.DataFrame) -> pd.DataFrame:
        ...
        is_bull_setup = is_id_vol & (c.shift(1) > sma50)
        is_bear_setup = is_id_vol & (c.shift(1) < sma50)
