"""
Ashva Quantitative Strategy: Inside Day Prior Value Area Pullback Thrust (123_alpha)
Category: MOMENTUM_PULLBACK
Market Mechanism: MOMENTUM

Hypothesis:
Inside Day compression retesting Prior Day High as support followed by strong expansion.
"""
...
class Alpha123InsideDayPriorValueAreaPullbackThrust(BaseHypothesis, BaseStrategy):
    strategy_id = "123_alpha"
    hypothesis_id = "123_alpha"
    name = "123_alpha — Inside Day Prior Value Area Pullback Thrust"
    ...
    def __init__(self, parameters: Optional[Dict[str, Any]] = None):
        ...
        metadata = HypothesisMetadata(
            ...
            name="123_alpha — Inside Day Prior Value Area Pullback Thrust",
            category="MOMENTUM_PULLBACK",
            economic_rationale="Inside Day compression retesting Prior Day High as support followed by strong expansion.",
            target_instruments=[],
            timeframe="15m",
        ...
        BaseStrategy.__init__(self, strategy_id="123_alpha", parameters=merged)
    ...
    def generate_signals(self, df: pd.DataFrame) -> pd.DataFrame:
        ...
        is_bull_setup = is_id & (c.shift(1) > sma50)
        is_bear_setup = is_id & (c.shift(1) < sma50)
