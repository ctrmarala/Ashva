"""
Ashva Quantitative Strategy: Macro 200 SMA Trend Compression Spring (Alpha 77)
Category: MACRO_200_SMA_TREND_SPRING
Market Mechanism: MOMENTUM_EXPANSION

Hypothesis:
When a liquid equity is in verified structural macro alignment with its 200-day Simple Moving Average
(Close[T-1] > 200-day SMA for Long, or Close[T-1] < 200-day SMA for Short) and exhibits controlled daily volatility
compression (Range[T-1] <= 0.75x 14-day ATR), institutional inventory rests in alignment with multi-quarter trend.
...
class Alpha77Macro200SMATrendSpring(BaseHypothesis, BaseStrategy):
    strategy_id = "77_alpha"
    hypothesis_id = "77_alpha"
    name = "77_alpha — Macro 200 SMA Trend Compression Spring"
    ...
    def __init__(self, parameters: Optional[Dict[str, Any]] = None):
        ...
        metadata = HypothesisMetadata(
            ...
            category="MACRO_200_SMA_TREND_SPRING",
            economic_rationale=(
                "200 SMA macro trend alignment combined with sub-0.75x ATR daily volatility compression "
        ...
        BaseStrategy.__init__(self, strategy_id="77_alpha", parameters=merged)
    ...
    def generate_signals(self, df: pd.DataFrame) -> pd.DataFrame:
        ...
        sma200 = c.shift(1).rolling(200, min_periods=30).mean()
        ...
        is_bull_trend = (c1 > sma200) & is_orderly
        is_bear_trend = (c1 < sma200) & is_orderly
