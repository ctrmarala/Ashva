"""
Ashva Quantitative Strategy: Opening Drive Failure Inside Gap Spring (113_alpha)
Category: GAP_FADE_EXHAUSTION
Market Mechanism: MEAN_REVERSION

Hypothesis:
Opening impulse rejection back into previous day value area.
"""
...
class Alpha113OpeningDriveFailureInsideGapSpring(BaseHypothesis, BaseStrategy):
    strategy_id = "113_alpha"
    hypothesis_id = "113_alpha"
    name = "113_alpha — Opening Drive Failure Inside Gap Spring"
    ...
    def __init__(self, parameters: Optional[Dict[str, Any]] = None):
        ...
        metadata = HypothesisMetadata(
            ...
            name="113_alpha — Opening Drive Failure Inside Gap Spring",
            category="GAP_FADE_EXHAUSTION",
            economic_rationale="Opening impulse rejection back into previous day value area.",
            target_instruments=[],
            timeframe="15m",
        ...
        BaseStrategy.__init__(self, strategy_id="113_alpha", parameters=merged)
