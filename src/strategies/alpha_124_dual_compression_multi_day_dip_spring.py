"""
Ashva Quantitative Strategy: Inside Day NR4 Multi-Day Dip Spring (124_alpha)
Category: MOMENTUM_PULLBACK
Market Mechanism: MOMENTUM

Hypothesis:
Inside Day and NR4 compression opening impulse momentum expansion.
"""
...
class Alpha124DualCompressionMultiDayDipSpring(BaseHypothesis, BaseStrategy):
    strategy_id = "124_alpha"
    hypothesis_id = "124_alpha"
    name = "124_alpha — Inside Day NR4 Multi-Day Dip Spring"
    ...
    def __init__(self, parameters: Optional[Dict[str, Any]] = None):
        ...
        metadata = HypothesisMetadata(
            ...
            name="124_alpha — Inside Day NR4 Multi-Day Dip Spring",
            category="MOMENTUM_PULLBACK",
            economic_rationale="Inside Day and NR4 compression opening impulse momentum expansion.",
            target_instruments=[],
            timeframe="15m",
        ...
        BaseStrategy.__init__(self, strategy_id="124_alpha", parameters=merged)
