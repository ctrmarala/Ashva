"""
Ashva Quantitative Strategy: 3-Day RS Trend EMA-20 Pullback Spring (120_alpha)
Category: MOMENTUM_PULLBACK
Market Mechanism: MOMENTUM

Hypothesis:
3-day momentum leadership re-accelerating after shallow morning retest.
"""
...
class Alpha120ThreeDayRsTrendEma20PullbackSpring(BaseHypothesis, BaseStrategy):
    strategy_id = "120_alpha"
    hypothesis_id = "120_alpha"
    name = "120_alpha — 3-Day RS Trend EMA-20 Pullback Spring"
    ...
    def __init__(self, parameters: Optional[Dict[str, Any]] = None):
        ...
        metadata = HypothesisMetadata(
            ...
            name="120_alpha — 3-Day RS Trend EMA-20 Pullback Spring",
            category="MOMENTUM_PULLBACK",
            economic_rationale="3-day momentum leadership re-accelerating after shallow morning retest.",
            target_instruments=[],
            timeframe="15m",
        ...
        BaseStrategy.__init__(self, strategy_id="120_alpha", parameters=merged)
    ...
    def generate_signals(self, df: pd.DataFrame) -> pd.DataFrame:
        ...
        is_3d_bull = (c.shift(1) > c.shift(2)) & (c.shift(2) > c.shift(3)) & (rng.shift(1) <= 0.80 * atr14) & (c.shift(1) > sma50)
        is_3d_bear = (c.shift(1) < c.shift(2)) & (c.shift(2) < c.shift(3)) & (rng.shift(1) <= 0.80 * atr14) & (c.shift(1) < sma50)
