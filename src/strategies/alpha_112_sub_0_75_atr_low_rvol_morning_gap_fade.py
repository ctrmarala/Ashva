"""
Ashva Quantitative Strategy: Sub-0.75 ATR Low RVOL Morning Gap Fade (112_alpha)
Category: GAP_FADE_EXHAUSTION
Market Mechanism: MEAN_REVERSION

Hypothesis:
Low-volume opening gap into resistance following volatility contraction.
"""
...
class Alpha112Sub075AtrLowRvolMorningGapFade(BaseHypothesis, BaseStrategy):
    strategy_id = "112_alpha"
    hypothesis_id = "112_alpha"
    name = "112_alpha — Sub-0.75 ATR Low RVOL Morning Gap Fade"
    ...
    def __init__(self, parameters: Optional[Dict[str, Any]] = None):
        ...
        metadata = HypothesisMetadata(
            ...
            name="112_alpha — Sub-0.75 ATR Low RVOL Morning Gap Fade",
            category="GAP_FADE_EXHAUSTION",
            economic_rationale="Low-volume opening gap into resistance following volatility contraction.",
            target_instruments=[],
            timeframe="15m",
        ...
        BaseStrategy.__init__(self, strategy_id="112_alpha", parameters=merged)
        self._current_pos: Dict[str, float] = {}

    def get_parameter_grid(self) -> Dict[str, List[Any]]:
        return {
            "min_gap": [0.0035, 0.0035 + 0.0010],
            "target_rr": [1.8, 1.8 + 0.15],
        }
    ...
    def generate_signals(self, df: pd.DataFrame) -> pd.DataFrame:
        ...
        is_comp = (rng.shift(1) < 0.75 * atr10) & (v.shift(1) < v.shift(2))
        is_bull_setup = is_comp & (c.shift(1) > sma50)
        is_bear_setup = is_comp & (c.shift(1) < sma50)
        ...
        target_rr = float(self.parameters.get("target_rr", 1.8))
