"""
Ashva Quantitative Strategy: Sub-0.80 ATR Gap and Reverse Morning Fill (111_alpha)
Category: GAP_FADE_EXHAUSTION
Market Mechanism: MEAN_REVERSION

Hypothesis:
Sub-0.80 ATR compression gap-and-go failure resulting in high-conviction opening fade.
"""
...
class Alpha111Sub080AtrGapAndReverseMorningFill(BaseHypothesis, BaseStrategy):
    strategy_id = "111_alpha"
    hypothesis_id = "111_alpha"
    name = "111_alpha — Sub-0.80 ATR Gap and Reverse Morning Fill"
    ...
    def __init__(self, parameters: Optional[Dict[str, Any]] = None):
        ...
        metadata = HypothesisMetadata(
            ...
            name="111_alpha — Sub-0.80 ATR Gap and Reverse Morning Fill",
            category="GAP_FADE_EXHAUSTION",
            economic_rationale="Sub-0.80 ATR compression gap-and-go failure resulting in high-conviction opening fade.",
            target_instruments=[],
            timeframe="15m",
        ...
        BaseStrategy.__init__(self, strategy_id="111_alpha", parameters=merged)
    ...
    def generate_signals(self, df: pd.DataFrame) -> pd.DataFrame:
        ...
        is_comp = (rng.shift(1) < 0.80 * atr14)
