"""
Ashva Quantitative Strategy: Inside Day 30m Initial Balance Expansion (118_alpha)
Category: INITIAL_BALANCE_EXPANSION
Market Mechanism: BREAKOUT

Hypothesis:
Inside Day + NR7 dual spring driving high-velocity expansion out of morning range.
"""
...
class Alpha118InsideDay30mInitialBalanceExpansion(BaseHypothesis, BaseStrategy):
    strategy_id = "118_alpha"
    hypothesis_id = "118_alpha"
    name = "118_alpha — Inside Day 30m Initial Balance Expansion"
    ...
    def __init__(self, parameters: Optional[Dict[str, Any]] = None):
        ...
        metadata = HypothesisMetadata(
            ...
            name="118_alpha — Inside Day 30m Initial Balance Expansion",
            category="INITIAL_BALANCE_EXPANSION",
            economic_rationale="Inside Day + NR7 dual spring driving high-velocity expansion out of morning range.",
            target_instruments=[],
            timeframe="15m",
        ...
        BaseStrategy.__init__(self, strategy_id="118_alpha", parameters=merged)
    ...
    def generate_signals(self, df: pd.DataFrame) -> pd.DataFrame:
        ...
        is_bull_setup = is_id & is_nr7 & (c.shift(1) > sma50)
        is_bear_setup = is_id & is_nr7 & (c.shift(1) < sma50)
