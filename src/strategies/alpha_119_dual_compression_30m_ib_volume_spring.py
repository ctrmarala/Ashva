"""
Ashva Quantitative Strategy: Inside Day Sub-0.75 ATR 30m IB Volume Spring (119_alpha)
Category: INITIAL_BALANCE_EXPANSION
Market Mechanism: BREAKOUT

Hypothesis:
Inside day and sub-0.75 ATR compression with opening impulse volume expansion.
"""
...
class Alpha119DualCompression30mIbVolumeSpring(BaseHypothesis, BaseStrategy):
    strategy_id = "119_alpha"
    hypothesis_id = "119_alpha"
    name = "119_alpha — Inside Day Sub-0.75 ATR 30m IB Volume Spring"
    ...
    def __init__(self, parameters: Optional[Dict[str, Any]] = None):
        ...
        metadata = HypothesisMetadata(
            ...
            name="119_alpha — Inside Day Sub-0.75 ATR 30m IB Volume Spring",
            category="INITIAL_BALANCE_EXPANSION",
            economic_rationale="Inside day and sub-0.75 ATR compression with opening impulse volume expansion.",
            target_instruments=[],
            timeframe="15m",
        ...
        BaseStrategy.__init__(self, strategy_id="119_alpha", parameters=merged)
    ...
    def generate_signals(self, df: pd.DataFrame) -> pd.DataFrame:
        ...
        is_bull_setup = is_id & is_sub75 & (c.shift(1) > sma50)
        is_bear_setup = is_id & is_sub75 & (c.shift(1) < sma50)
