"""
Ashva Quantitative Strategy: Sub-0.75 ATR Inside Spring (Alpha 60)
Category: VOLATILITY_COMPRESSION_SPRING
Market Mechanism: BREAKOUT

Hypothesis:
When Day T-1 is an Inside Day whose range is compressed below 75% of 10-day ATR,
equilibrium coiling is reached with statistical sample breadth.
Day T morning opening 15m breakout bar triggers directional expansion with high win rate.
"""
...
class Alpha60Sub75ATRInsideSpring(BaseHypothesis, BaseStrategy):
    strategy_id = "60_alpha"
    hypothesis_id = "60_alpha"
    name = "60_alpha — Sub-0.75 ATR Inside Spring"
    ...
    def __init__(self, parameters: Optional[Dict[str, Any]] = None):
        ...
        metadata = HypothesisMetadata(
            ...
            category="VOLATILITY_COMPRESSION_SPRING",
            economic_rationale=(
                "Inside Day with sub-0.75x ATR range compression sets up institutional inventory breakout."
            ),
            target_instruments=[],
            timeframe="15m",
        ...
        BaseStrategy.__init__(self, strategy_id="60_alpha", parameters=merged)
    ...
    def generate_signals(self, df: pd.DataFrame) -> pd.DataFrame:
        ...
        is_sub75 = rng.shift(1) < (0.75 * atr10)
        is_spring = is_id & is_sub75
