"""
Ashva Quantitative Strategy: Inside Day Morning PDH/PDL Gap Exhaustion Fade (110_alpha)
Category: GAP_FADE_EXHAUSTION
Market Mechanism: MEAN_REVERSION

Hypothesis:
Inside day gap overextension into key levels with immediate reversal and mean-fill.
"""
...
class Alpha110InsideDayMorningPdhPdlGapExhaustionFade(BaseHypothesis, BaseStrategy):
    strategy_id = "110_alpha"
    hypothesis_id = "110_alpha"
    name = "110_alpha — Inside Day Morning PDH/PDL Gap Exhaustion Fade"
    ...
    def __init__(self, parameters: Optional[Dict[str, Any]] = None):
        ...
        metadata = HypothesisMetadata(
            ...
            name="110_alpha — Inside Day Morning PDH/PDL Gap Exhaustion Fade",
            category="GAP_FADE_EXHAUSTION",
            economic_rationale="Inside day gap overextension into key levels with immediate reversal and mean-fill.",
            target_instruments=[],
            timeframe="15m",
        ...
        BaseStrategy.__init__(self, strategy_id="110_alpha", parameters=merged)
