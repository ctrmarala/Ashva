"""
Ashva Quantitative Strategy: 3-Day Trend Volume-Weighted Band Bounce (108_alpha)
Category: VWAP_MEAN_REVERSION
Market Mechanism: MEAN_REVERSION

Hypothesis:
3-day momentum trend continuation from intraday volume-weighted value areas.
"""
...
class Alpha108ThreeDayTrendVolumeWeightedBandBounce(BaseHypothesis, BaseStrategy):
    strategy_id = "108_alpha"
    hypothesis_id = "108_alpha"
    name = "108_alpha — 3-Day Trend Volume-Weighted Band Bounce"
    ...
    def __init__(self, parameters: Optional[Dict[str, Any]] = None):
        ...
        metadata = HypothesisMetadata(
            ...
            name="108_alpha — 3-Day Trend Volume-Weighted Band Bounce",
            category="VWAP_MEAN_REVERSION",
            economic_rationale="3-day momentum trend continuation from intraday volume-weighted value areas.",
            target_instruments=[],
            timeframe="15m",
        ...
        BaseStrategy.__init__(self, strategy_id="108_alpha", parameters=merged)
    ...
    def generate_signals(self, df: pd.DataFrame) -> pd.DataFrame:
        ...
        is_3d_bull = (c.shift(1) > c.shift(2)) & (c.shift(2) > c.shift(3)) & (rng.shift(1) < 0.85 * atr14) & (c.shift(1) > sma50)
        is_3d_bear = (c.shift(1) < c.shift(2)) & (c.shift(2) < c.shift(3)) & (rng.shift(1) < 0.85 * atr14) & (c.shift(1) < sma50)
        is_bull_setup = is_3d_bull
        is_bear_setup = is_3d_bear
