"""
Ashva Quantitative Strategy: Sub-0.80 ATR VWAP Equilibrium Bounce (109_alpha)
Category: VWAP_MEAN_REVERSION
Market Mechanism: MEAN_REVERSION

Hypothesis:
Range and volume dry-up compression on T-1 bouncing off VWAP equilibrium.
"""
...
class Alpha109Sub080AtrVwapEquilibriumBounce(BaseHypothesis, BaseStrategy):
    strategy_id = "109_alpha"
    hypothesis_id = "109_alpha"
    name = "109_alpha — Sub-0.80 ATR VWAP Equilibrium Bounce"
    ...
    def __init__(self, parameters: Optional[Dict[str, Any]] = None):
        ...
        metadata = HypothesisMetadata(
            ...
            name="109_alpha — Sub-0.80 ATR VWAP Equilibrium Bounce",
            category="VWAP_MEAN_REVERSION",
            economic_rationale="Range and volume dry-up compression on T-1 bouncing off VWAP equilibrium.",
            target_instruments=[],
            timeframe="15m",
        ...
        BaseStrategy.__init__(self, strategy_id="109_alpha", parameters=merged)
    ...
    def generate_signals(self, df: pd.DataFrame) -> pd.DataFrame:
        ...
        is_dryup = (rng.shift(1) < 0.80 * atr10) & (v.shift(1) < v.shift(2))
        is_bull_setup = is_dryup & (c.shift(1) > sma50)
        is_bear_setup = is_dryup & (c.shift(1) < sma50)
