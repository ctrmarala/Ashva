"""
Ashva Quantitative Strategy: Trend-Aligned 20 EMA Inside Spring (Alpha 59)
Category: TREND_ALIGNED_COMPRESSION
Market Mechanism: BREAKOUT

Hypothesis:
When an equity experiences an Inside Day on Day T-1 that closes above its 20-day exponential moving average (EMA20)
for bullish setups, or below EMA20 for bearish setups, the volatility compression occurs within the path of least resistance.
Day T opening 15m breakout bar aligns with the prevailing institutional trend for high-conviction follow-through.
"""
...
class Alpha59TrendAlignedEMASpring(BaseHypothesis, BaseStrategy):
    strategy_id = "59_alpha"
    hypothesis_id = "59_alpha"
    name = "59_alpha — Trend-Aligned 20 EMA Inside Spring"
    ...
    def __init__(self, parameters: Optional[Dict[str, Any]] = None):
        ...
        metadata = HypothesisMetadata(
            ...
            category="TREND_ALIGNED_COMPRESSION",
            economic_rationale=(
                "Inside Day compression aligned with 20-day EMA trend direction creates high-probability "
                "breakout expansion in the direction of the institutional primary trend."
            ),
            target_instruments=[],
            timeframe="15m",
        ...
        BaseStrategy.__init__(self, strategy_id="59_alpha", parameters=merged)
    ...
    def generate_signals(self, df: pd.DataFrame) -> pd.DataFrame:
        ...
        cond_long = is_id & (c.shift(1) > ema20)
        cond_short = is_id & (c.shift(1) < ema20)
