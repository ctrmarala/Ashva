"""
Ashva Quantitative Strategy: Inside Day NR4 Opening Gap Rejection Fade (114_alpha)
Category: GAP_FADE_EXHAUSTION
Market Mechanism: MEAN_REVERSION

Hypothesis:
Inside day and NR4 volatility contraction gap rejection fade.
"""
...
class Alpha114DualInsideDayOpeningGapRejectionFade(BaseHypothesis, BaseStrategy):
    strategy_id = "114_alpha"
    hypothesis_id = "114_alpha"
    name = "114_alpha — Inside Day NR4 Opening Gap Rejection Fade"
    ...
    def __init__(self, parameters: Optional[Dict[str, Any]] = None):
        ...
        metadata = HypothesisMetadata(
            ...
            name="114_alpha — Inside Day NR4 Opening Gap Rejection Fade",
            category="GAP_FADE_EXHAUSTION",
            economic_rationale="Inside day and NR4 volatility contraction gap rejection fade.",
            target_instruments=[],
            timeframe="15m",
        ...
        BaseStrategy.__init__(self, strategy_id="114_alpha", parameters=merged)
    ...
    def generate_signals(self, df: pd.DataFrame) -> pd.DataFrame:
        ...
        is_bull_setup = (is_id | is_nr4) & (c.shift(1) > sma50)
        is_bear_setup = (is_id | is_nr4) & (c.shift(1) < sma50)
