"""
Ashva Quantitative Strategy: Inside Day Opening Gap Expansion (Alpha 31)
Category: VOLATILITY_EXPANSION
Market Mechanism: BREAKOUT

Hypothesis:
Inside Day compression followed by an opening gap (0.35%–2.00%) with RVOL >= 1.20x triggers
explosive volatility expansion toward a 1.50R target with break-even trailing.
"""
...
class Alpha31InsideDayOpeningGapExpansion(BaseHypothesis, BaseStrategy):
    strategy_id = "31_alpha"
    hypothesis_id = "31_alpha"
    name = "31_alpha — Inside Day Opening Gap Expansion"
    ...
    def __init__(self, parameters: Optional[Dict[str, Any]] = None):
        ...
        metadata = HypothesisMetadata(
            ...
            category="VOLATILITY_EXPANSION",
            economic_rationale=(
                "Inside day compression creates a volatility coiled spring. Opening gap with volume shock "
                "triggers strong institutional momentum toward a 1.50R target."
            ),
            target_instruments=[],
            timeframe="15m",
        ...
        BaseStrategy.__init__(self, strategy_id="31_alpha", parameters=merged)
