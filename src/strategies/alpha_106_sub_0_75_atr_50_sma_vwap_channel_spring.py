"""
Ashva Quantitative Strategy: Sub-0.75 ATR 50-SMA VWAP Channel Spring (106_alpha)
Category: VWAP_MEAN_REVERSION
Market Mechanism: MEAN_REVERSION

Hypothesis:
Sub-0.75 ATR compression + macro trend alignment creates high-conviction VWAP bounce.
"""
...
class Alpha106Sub075Atr50SmaVwapChannelSpring(BaseHypothesis, BaseStrategy):
    strategy_id = "106_alpha"
    hypothesis_id = "106_alpha"
    name = "106_alpha — Sub-0.75 ATR 50-SMA VWAP Channel Spring"
    ...
    def __init__(self, parameters: Optional[Dict[str, Any]] = None):
        ...
        metadata = HypothesisMetadata(
            ...
            name="106_alpha — Sub-0.75 ATR 50-SMA VWAP Channel Spring",
            category="VWAP_MEAN_REVERSION",
            economic_rationale="Sub-0.75 ATR compression + macro trend alignment creates high-conviction VWAP bounce.",
            target_instruments=[],
            timeframe="15m",
        ...
        BaseStrategy.__init__(self, strategy_id="106_alpha", parameters=merged)
