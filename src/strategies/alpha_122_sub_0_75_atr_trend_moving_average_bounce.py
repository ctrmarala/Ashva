"""
Ashva Quantitative Strategy: Sub-0.75 ATR Trend Moving Average Bounce (122_alpha)
Category: MOMENTUM_PULLBACK
Market Mechanism: MOMENTUM

Hypothesis:
Sub-0.75 ATR volatility compression bounce in the direction of dominant 50 SMA.
"""
...
class Alpha122Sub075AtrTrendMovingAverageBounce(BaseHypothesis, BaseStrategy):
    strategy_id = "122_alpha"
    hypothesis_id = "122_alpha"
    name = "122_alpha — Sub-0.75 ATR Trend Moving Average Bounce"
    ...
    def __init__(self, parameters: Optional[Dict[str, Any]] = None):
        ...
        metadata = HypothesisMetadata(
            ...
            name="122_alpha — Sub-0.75 ATR Trend Moving Average Bounce",
            category="MOMENTUM_PULLBACK",
            economic_rationale="Sub-0.75 ATR volatility compression bounce in the direction of dominant 50 SMA.",
            target_instruments=[],
            timeframe="15m",
        ...
        BaseStrategy.__init__(self, strategy_id="122_alpha", parameters=merged)
